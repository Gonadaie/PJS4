...
insert into adjective (wording) values ('Ambitieux') ;
insert into adjective (wording) values ('Altruiste') ;
insert into adjective (wording) values ('Cupide') ;
insert into adjective (wording) values ('Sympathique') ;
...
insert into adjective (wording) values ('Arrogant') ;
...
insert into adjective (wording) values ('Drôle') ;
insert into adjective (wording) values ('Sudiste') ;
insert into adjective (wording) values ('Tyrannique') ;
insert into adjective (wording) values ('Sociable') ;
insert into adjective (wording) values ('Fêtard') ;
insert into adjective (wording) values ('Extraverti') ;
