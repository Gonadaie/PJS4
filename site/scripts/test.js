...
var AdjectiveContainer = function (_React$Component) {
	_inherits(AdjectiveContainer, _React$Component);

	function AdjectiveContainer() {
		_classCallCheck(this, AdjectiveContainer);

		return _possibleConstructorReturn(this, (AdjectiveContainer.__proto__ || Object.getPrototypeOf(AdjectiveContainer)).apply(this, arguments));
	}

	_createClass(AdjectiveContainer, [{
		key: "render",
		value: function render() {
			var adj = this.props.adj;
			return _react2.default.createElement(
				"div",
				{ style: { width: "100%", height: "100%" } },
				adj.map(function (name, index) {
					return _react2.default.createElement(Adjective, { wording: name });
				})
			);
		}
	}]);

	return AdjectiveContainer;
}(_react2.default.Component);

;

var Adjective = function (_React$Component2) {
	_inherits(Adjective, _React$Component2);
	...
	xhttp.onreadystatechange = function () {
		if (this.readyState == 4 && this.status == 200) {
			if (this.responseText != false) {
				...
				display_adj(json);
			} else console.log("Erreur : impossible de charger les adjectifs...");
		}
	};
