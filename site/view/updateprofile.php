...
?>
	...
	<body>
		...
		<div class="edit_profile">
			<img class="edit first_foregrand" src="../images/edit.png" alt="edit">
			<img class="confirm first_foregrand" src="../images/checked.png" alt="edit">
			<img class="cancel first_foreground" src="../images/cancel-button-3.png" alt="edit">
		</div>
			...
			$('.crop_image').click(function(event) { <!--	fonction qui s'execute quand on click sur le bouton final!!!!-->
				$image_crop.croppie('result', { <!--	methode pour obtenir l'immage coupée!!!!-->
					...
					$.ajax({
						...
						data: {
							"image": response
						}, <!--	ce qu'on veut envoyer au serveur, une immage qui est contenue dans la réponse pour le serveur!!!!-->
